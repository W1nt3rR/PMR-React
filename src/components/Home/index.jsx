    ...
    return <Layout>
        ...
        <Card type="navCard">
            ...
            <div>
                ...
                <Button text="Learn More" type="coloured" onClick={() => navigation("/magisk")}/>
            </div>
        </Card>
        ...
        <Card type="navCard">
            ...
            <div>
                ...
                <Button text="Modules" type="coloured" onClick={() => navigation("/modules")}/>
            </div>
        </Card>
        ...
        <Card type="navCard">
            ...
            <div>
                ...
                <Button text="Gcam" type="coloured" onClick={() => navigation("/gcam")}/>
            </div>
        </Card>
        ...
        <Card type="navCard">
            ...
            <div>
                ...
                <Button text="FAQ" type="coloured" onClick={() => navigation("/faq")}/>
            </div>
        </Card>
